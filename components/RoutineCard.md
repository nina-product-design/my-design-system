...
| Frequency Options | FrequencyOption[] (passed to FrequencySelector) |
| Default Frequency Index | number (which option is pre-selected) |
...
- Frequency selector: uses FrequencySelector component (see Selector.md)

## Code
- `src/components/RoutineCard/RoutineCard.tsx`
- `src/components/Selector/FrequencySelector.tsx` (frequency selector sub-component)
